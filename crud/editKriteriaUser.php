<?php
    ...
    if( isset($_POST['submit']) ) {
        ...
        // alert dan re direct
        echo "<script>alert('Data Kriteria berhasil di edit!'); document.location.href = '../user/index.php';</script>";
    }
        ...
        <div class="navbar-fixed">
            <nav class="grey darken-2">
                <div class="nav-wrapper container">
                    <a href="../user/index.php"><i class="material-icons left">keyboard_backspace</i>Kembali</a>
                ...
                <form action="" method="post" enctype="multipart/form-data">
                    <table>
                        ...
                        <tr>
                            ...
                            <td><input class="grey-text" type="text" name="noKriteria" value="<?= $nomor ?>" autocomplete="off" readonly=""></td>
                        </tr>
                        <tr>
                            <td>Nama Kriteria</td>
                            <td><input class="grey-text" type="text" name="namaKriteria" value="<?= $nama ?>" autocomplete="off" readonly=""></td>
                        </tr>
                        <tr style="display:none;">
                            <td>Cost/Benefit</td>
                            <td><input class="grey-text" type="text" name="costBenefit" value="<?= $costBenefit ?>" autocomplete="off" readonly=""></td>
                        </tr>
                        <tr>
                            <td>Bobot</td>
